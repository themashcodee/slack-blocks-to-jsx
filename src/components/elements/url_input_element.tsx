...
import type { UrlTextInputElement } from "../../types";
import { TextObject } from "../composition_objects";

type UrlInputElementProps = {
  data: UrlTextInputElement;
};

export const UrlInputElement = (props: UrlInputElementProps) => {
  ...
  return (
    <div
      id={action_id}
      className="relative text-small w-full slack_blocks_to_jsx__url_input_element"
    >
      {!value && placeholder && (
