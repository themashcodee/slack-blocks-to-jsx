...
import type { ConversationsSelectElement as ConversationsSelectElementType } from "../../types";
import { TextObject } from "../composition_objects";

type ConversationsSelectElementProps = {
  data: ConversationsSelectElementType;
};

export const ConversationsSelectElement = (props: ConversationsSelectElementProps) => {
  ...
  return (
    <div
      id={action_id}
      className="py-1 px-2 h-7 min-h-[28px] relative flex items-center justify-between rounded text-small w-[190px] border border-black-primary.3 dark:border-dark-border dark:bg-dark-bg-secondary dark:text-dark-text-primary slack_blocks_to_jsx__conversations_select_element"
      tabIndex={0}
    >
